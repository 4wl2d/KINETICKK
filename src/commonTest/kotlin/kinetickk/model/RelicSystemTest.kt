...
class RelicSystemTest {
    ...
    fun everyRelicCanBeEquippedAndKeepsTheSimulationFinite() {
        RelicId.entries.forEach { relicId ->
            ...
            repeat(90) { engine.update(GameEngine.FIXED_STEP) }
    ...
    private fun chooseFirstCompletingOption(engine: GameEngine) {
    ...
    private fun assertFiniteState(engine: GameEngine, relicId: RelicId) {
    ...
    private fun fullRelicEngine(seed: Int): GameEngine = runningEngine(seed).apply {
