...
object ItemCatalog {
    ...
    val all: List<ItemDefinition> = buildList(ITEM_COUNT) {
...
object WeaponCatalog {
    val all: List<WeaponDefinition> = listOf(
        ...
        WeaponDefinition(WeaponId.SINGULARITY_SPEAR, "Singularity Spear", "Every overdrive cycle forges a boss-piercing spear from collapsed void matter.", listOf("ULTIMATE", "OVERDRIVE", "BOSS"), 1_200),
...
object MetaUpgradeCatalog {
    val all: List<MetaUpgradeDefinition> = listOf(
        ...
        MetaUpgradeDefinition(MetaUpgradeId.SALVAGE_PROTOCOL, "Salvage Protocol", "+5% Void Matter gained during runs.", 10, 34, ItemModifier(ItemEffect.MATTER_GAIN, 0.05f)),
