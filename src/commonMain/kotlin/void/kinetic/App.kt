...
import void.kinetic.ui.drawKineticVoid
import void.kinetic.ui.GameTextMeasurer
import void.kinetic.audio.GameAudio
...
fun KineticVoidApp() {
    ...
    Canvas(
        ...
        drawKineticVoid(engine, textMeasurer, renderTimeSecondsValue)
    }
}
