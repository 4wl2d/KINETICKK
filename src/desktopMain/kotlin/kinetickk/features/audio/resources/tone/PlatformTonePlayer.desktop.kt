...
internal actual class PlatformTonePlayer actual constructor() : NumericTonePlayer {
    ...
    actual override fun unlock() = Unit

    actual override fun play(frequency: Float, durationSeconds: Float, volume: Float, wave: Int) {
