...
import kinetickk.feature.game.domain.protocol.BoundedVisualFxCueAccumulator
...
internal class MutableGameState(
    ...
    internal var upcomingRebirthProfile = RebirthProgression.profile(activeRebirthProfile.tier + 1)
    ...
    internal val discoveredItemIds = bootstrapProgress?.discoveredItemIds
    ...
    internal val soundCues = mutableListOf<SoundCue>()
    internal var visualFxCues = BoundedVisualFxCueAccumulator()
    internal var persistenceRequested = false
    ...
    internal var overlayReturnPhase = GamePhase.MENU
