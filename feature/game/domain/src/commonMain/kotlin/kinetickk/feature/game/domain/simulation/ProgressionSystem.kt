...
internal fun MutableGameState.isWeaponUnlocked(id: WeaponId): Boolean = id in unlockedWeaponSet

internal fun MutableGameState.buyMetaUpgrade(id: MetaUpgradeId): Boolean {
...
internal fun MutableGameState.buyOrEquipWeapon(id: WeaponId): Boolean {
...
internal fun MutableGameState.persist() {
    persistenceRequested = true
}

internal fun MutableGameState.progressSnapshot(): StoredProgress = StoredProgress(
        matter = totalMatter,
...
internal fun MutableGameState.takePersistenceRequest(): StoredProgress? {
    if (!persistenceRequested) return null
    persistenceRequested = false
    return progressSnapshot()
}

internal fun MutableGameState.takeSoundCues(): List<SoundCue> {
...
internal fun MutableGameState.emitSound(cue: SoundCue) {
