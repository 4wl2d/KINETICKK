...
import kinetickk.feature.game.domain.model.damageNumberTier
import kinetickk.feature.game.domain.model.DamageNumberTier
...
internal fun DrawScope.drawTrail(engine: GameProjection, shakeX: Float, shakeY: Float) {
...
internal fun DrawScope.drawScreenFx(engine: GameProjection, renderTime: Float) {
...
internal fun DrawScope.drawWeapon(engine: GameProjection, core: Offset, shakeX: Float, shakeY: Float) {
...
internal fun DrawScope.drawWeaponNodes(engine: GameProjection, shakeX: Float, shakeY: Float) {
...
internal fun DrawScope.drawCore(engine: GameProjection, center: Offset) {
