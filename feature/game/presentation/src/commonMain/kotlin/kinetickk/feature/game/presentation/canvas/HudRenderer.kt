...
internal fun DrawScope.drawHud(engine: GameProjection, textMeasurer: TextMeasurer) {
...
internal fun DrawScope.drawRelicMatrix(engine: GameProjection, textMeasurer: TextMeasurer, narrow: Boolean, right: Float) {
...
internal fun DrawScope.drawControls(engine: GameProjection, textMeasurer: TextMeasurer) {
