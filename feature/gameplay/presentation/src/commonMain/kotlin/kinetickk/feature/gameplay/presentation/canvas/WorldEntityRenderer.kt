...
import kinetickk.feature.gameplay.domain.model.TAU
...
internal fun DrawScope.drawEnemy(engine: GameplayRenderModel, enemy: EnemyProjection, shakeX: Float, shakeY: Float) {
