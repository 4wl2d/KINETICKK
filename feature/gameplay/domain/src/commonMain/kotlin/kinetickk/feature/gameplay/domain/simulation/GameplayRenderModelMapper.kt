...
import kinetickk.feature.gameplay.domain.renderModel.PickupProjection
import kinetickk.feature.gameplay.domain.renderModel.ProjectileProjection
import kinetickk.feature.gameplay.domain.renderModel.TotemProjection
import kinetickk.feature.gameplay.domain.renderModel.TrailPointProjection
import kinetickk.feature.gameplay.domain.renderModel.WeaponNodeProjection
import kinetickk.feature.gameplay.domain.renderModel.WeaponOrbitalProjection
...
internal fun MutableGameState.copyForReduction(): MutableGameState {
    ...
    target.pendingDiscoveredItemIds.clear()
    ...
    target.pendingBankedMatter = pendingBankedMatter
    target.pendingClearedRebirthLevel = pendingClearedRebirthLevel
