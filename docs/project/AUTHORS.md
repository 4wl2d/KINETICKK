...
- Vladislav Tomilov — GitHub [`@4wl2d`](https://github.com/4wl2d)

As of 15 July 2026, all project commits through source revision `3abbfea` use
the `4wl2d` author identity. Vladislav Tomilov states that this is his account.
That revision declares project version `0.1.0`.

The project previously used the title Kinetic Void. No affiliation with Badland
Studio or its game of that name is claimed, and no trademark rights in that
former title are asserted.
