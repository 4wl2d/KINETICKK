...
class ContentCatalogTest {
    @Test
    fun publishedCatalogCollectionsExposeNoMutationAuthority() {
        assertFalse((ItemCatalog.all as Any) is MutableList<*>)
        assertFalse((WeaponCatalog.all as Any) is MutableList<*>)
        assertFalse((MetaUpgradeCatalog.all as Any) is MutableList<*>)
        assertFalse((RelicCatalog.all as Any) is MutableList<*>)
        assertTrue(WeaponCatalog.all.all { (it.tags as Any) !is MutableList<*> })
    }
